    ...
    (set, get) => ({
      ...
      getAIResponse: async (messages: ChatMessage[], context?: any) => {
        try {
          ...
          const systemMessage = `You are an AI career assistant for CCAI Jobs by AI-Powered Careers Easy AI Labs, specializing in AI and tech careers. 
              ...
              <div class="container">
                ...
                <div class="content">
                  ...
                  <div style="text-align: center; margin: 30px 0;">
                    <a href="https://ccaijobs.com/dashboard" class="button">View Full Dashboard</a>
                    <a href="https://ccaijobs.com/jobs" class="button">Explore Jobs</a>
                  </div>
                </div>

                <div class="footer">
                  <p>CCAI Jobs by AI-Powered Careers Easy AI Labs Career Coach | Powered by Advanced AI</p>
                  <p>
                    <a href="https://ccaijobs.com/settings" style="color: #667eea;">Notification Settings</a> | 
                    <a href="https://ccaijobs.com/unsubscribe" style="color: #667eea;">Unsubscribe</a>
                  </p>
                </div>
              </div>
            </body>
...
View your full dashboard: https://ccaijobs.com/dashboard
          `;

          await email.sendEmail({
            from: 'career-coach@ccaijobs.com',
...
Format as JSON with optimized sections.`;
      ...
      sendScheduledEmails: async () => {
        ...
        for (const scheduledEmail of emailsToSend) {
          try {
            await email.sendEmail({
              from: 'notifications@ccaijobs.com',
              ...
              <div class="container">
                ...
                <div class="content">
                  ...
                  <div style="text-align: center; margin: 40px 0;">
                    <a href="https://ccaijobs.com/dashboard" class="button">View Dashboard</a>
                    <a href="https://ccaijobs.com/jobs" class="button">Explore New Jobs</a>
                  </div>
                </div>

                <div class="footer">
                  <p><strong>CCAI Jobs by AI-Powered Careers Easy AI Labs Weekly Report</strong></p>
